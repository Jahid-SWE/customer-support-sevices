...
import { FaFacebook,FaLinkedinIn,FaEnvelope,FaGlobe   } from 'react-icons/fa6'; 
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-8">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-3 pb-12">
                    ...
                    <div>
                        ...
                        <ul className="text-sm mt-2 space-y-2 text-slate-400">
                            <li className='flex pr-2'><FaFacebook size={24} className="text-blue-600 mr-2" />@CS — Ticket System</li>
                            <li className='flex pr-2'><FaLinkedinIn size={24} className="text-blue-600 mr-2" />@CS — Ticket System</li>
                            <li className='flex pr-2'><FaEnvelope size={24} className="text-blue-600 mr-2" />@CS — Ticket System</li>
                            <li className='flex pr-2'><FaGlobe size={24} className="text-blue-600 mr-2" />support@cst.com</li>
                        </ul>
                    </div>
                </div>
